...
const VENTURES = [
  ...
  },
  {
    ...
    icon: <img src={snapshareLogo} className="snapshare-featured-logo" alt="SnapShare AI" />,
  },
  {
    name: 'ZilCubator',
  ...
  },
  {
    ...
    color: 'amber',
    icon: <img src={fitmyjobLogo} className="logo-full" alt="FitMyJob" />,
  },
  {
    name: 'Paywint',
    role: 'Growth Support',
      ...
      <div className="container">
        ...
        >
          <div className="snapshare-left">
            ...
            <h3 className="snapshare-name">SnapShare AI</h3>
          ...
          <div className="snapshare-right">
            <div className="snapshare-card">
              ...
              <div className="snapshare-icon-ring">
                <img src={snapshareLogo} className="snapshare-featured-logo" alt="SnapShare AI Logo" />
              </div>
